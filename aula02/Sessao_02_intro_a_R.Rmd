...
+ 1997: o [R core group]() é criado daqui vem o código principal. 
+ Outros membros sugerem mudanças
+ R Foundation mantém hoje - mas organizações satélite como R Consortium e até empresas privadas como RStudio <!-- - que desenvolve RStudio e sedia alguns dos cientistas de dados que desenvolvem parte do ecossistema de R. --> 
...
+ Cross-platform: qualquer plataforma e sistema operativo
+ Capacidade gráfica!
+ Desenvolvimento ativo, uma comunidade super ativa, listas de emails, stack overflow, __A comunidade cria a maior parte dos pacotes__
+ free: gratuito e livre
+ Livre de rodar para o que você quiser, de adaptar e modificar o que for preciso, de venda
---
# O CRAN
+ base R é salvo no CRAN : the comprehensive R archive network.
...
+ reprodutibilidade, _script-based_, no clicks
...
+ CRAN: Comprehensive R Arquive Network, com espelhos no mundo todo (no Brasil, UFPR, FIOCRUZ)
