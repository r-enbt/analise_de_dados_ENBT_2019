...
\begin{figure}[!htbp]
\includegraphics[scale=0.31]{figuras/reflexo.png}
\end{figure}
...
\subfloat{{ \includegraphics[scale=0.4]{figuras/tukey.jpg} }}
 \qquad
 \hspace{0.6cm}
\subfloat{{ \includegraphics[scale=0.5]{figuras/John_Tukey.jpg} }}

\end{figure}

## conheça seus dados!

\center \includegraphics{figuras/pee.jpg}
...
\center
\includegraphics[scale=.2]{figuras/tortura.jpg}
...
\center \includegraphics[scale=0.3]{figuras/cover.png}
...
\center \includegraphics[scale=0.8]{figuras/Francis_Anscombe.jpeg}
...
```{r, fig.align='center', fig.width=3.8, fig.height=3.5}
cor.c <- "grey40"
