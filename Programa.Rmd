...
|-------:|--:|--:|--:|--:|--:|  
|  09h00 |  Sessão 1|  4|  9|  13|  17|  
|  11h00 |  Sessão 2|  5|  10|  14|  18|  
|  13h30 |  Sessão 3|  6| 11|  15|  19|  
|  15h00 | Sessão 4 |  7|  12|  16|  20|  

## Día 1
### Sessão 1a. Introdução, apresentação da disciplina
...
### Sessão 1b. Introdução à ciência aberta
...
### Sessão 2 - Introdução ao ambiente estatístico R:
...
## Día 2
### Sessão 4 - Estrutura de um projeto de análise de dados
+ Estruturas de pastas do computador
...
### Sessão 5 - Organização e formatação de dados
...
usando a codificação padrão, ponto como decimal.

+ Good data entry practices - formatting data tables in spreadsheets
+ How to avoid common formatting mistakes
+ Approaches for handling dates in spreadsheet
+ Basic quality control and data manipulation in spreadsheets
+ Exporting data from spreadsheets
        
### Sessão 7- Lendo dados em R - exploração inicial


### Sessão 6 - Formatação e limpeza de dados (juntar os temas das sesiones 5 y 6?)


## Día 3
### Sessão 8 - Dataframes, listas, vetores
### Sessão 9 - Análise exploratória de dados
### Sessão 10 - Armazenamento backup e cuidado dos dados (T)
### Sessão 11 - Visualização de dados
### Sessão 12 - R para biólogos, ecólogos e taxonomistas

### Sessão 13 - Introdução a Rmarkdown
 
 <!-- Abrir uno nuevo, cliquear en knit, observar.
estructura de un archivo de markdown:

Cabeçalho,
Contenido dividido en texto vs. chunks,
Control de lo que rueda por dentro: eval
Control de lo que sale: echo


ver qué Page Piccinini

No olvidar:


- opciones de formato : word, documento de referencia

- bibliografía: zotero, mendeley, bibtex --> 
